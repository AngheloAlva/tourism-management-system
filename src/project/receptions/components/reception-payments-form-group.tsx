...
export const ReceptionPaymentsFormGroup = withFieldGroup({
	defaultValues: {
	...
	render: function PaymentsRender({ group }) {
		return (
			<div className="px-4">
				<div className="gap-0">
					<CardTitle className="text-2xl font-bold">Registro de Pago</CardTitle>
					<CardDescription>Pagos asociados al traslado</CardDescription>
				</div>
											...
											<CardContent>
												<div className="flex items-center justify-between">
													<div>
														...
														<group.Subscribe
															selector={(state: any) => {
																const pays = state.values.payments || []
																return pays.reduce((total: number, payment: any) => {
