...
export const transferAgencyColumns: ColumnDef<TransferAgency>[] = [
	{
		accessorKey: "name",
			...
			return (
				<DropdownMenu>
					...
					<DropdownMenuContent align="end">
						...
						<DropdownMenuItem
							onClick={() => {
								const event = new CustomEvent("editTransferAgency", { detail: agency })
						...
						<DropdownMenuItem
							onClick={() => {
								const event = new CustomEvent("toggleTransferAgency", { detail: agency.id })
								window.dispatchEvent(event)
							}}
						>
						...
						<DropdownMenuItem
							onClick={() => {
								const event = new CustomEvent("deleteTransferAgency", { detail: agency.id })
								window.dispatchEvent(event)
							}}
